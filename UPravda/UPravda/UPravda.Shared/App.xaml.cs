...
namespace UPravda
{
    ...
    public sealed partial class App : Application
    {
        ...
        {
#if WINDOWS_APP
            BugSenseHandler.Instance.InitAndStartSession(new ExceptionManager(Current), "w8c7062e");
            ...
            Windows.Globalization.ApplicationLanguages.PrimaryLanguageOverride = App.Language;
        }
        public static ElementTheme Theme
        {
            get { return SettingHelper.GetSetting<ElementTheme>(Settings.AppTheme, ElementTheme.Dark); }
        }
        ...
        public static string Language
        {
            get
            {
                return SettingHelper.GetSetting<string>(Settings.Language, "uk-UA");
            }
        }
        ...
        {
            args.Request.ApplicationCommands.Add(new SettingsCommand("Setting", "Налаштування", (handler) => ShowCustomSettingFlyout()));
        }
